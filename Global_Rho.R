...
covid_data = read_csv("weekly_df.csv")
...
set.seed(2062379496)
runif_design(
  lower=c(b1=1, b2= 1, b3 = 5, k1 = 0.5, k2 = 1, k3 = 1, mu_EI = 0.5, mu_IR= 0.7, rho1=0.01, rho2=0.3, rho3=0.05, eta=0.4),
  upper=c(b1=5, b2 = 10, b3 = 15, k1 = 2, k2=10, k3= 6, mu_EI = 3, mu_IR= 2, rho1=0.2, rho2=0.7, rho3=0.2, eta=1),
  nseq=NUM_GUESSES
) -> guesses
mf1 <- mifs_local[[1]]
...
write.csv(seir_global_results, "Global_rho_jump.csv")
